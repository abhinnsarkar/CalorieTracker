...
//             <div className="flex mx-auto bg-red-600 w-[75%]">
...
//                 </span>
//             </div>
//             <main className="flex-1 container mx-auto px-4 flex justify-center items-center text-center bg-green-200">
//                 <div className="max-w-lg w-full">
//                     {/* Welcome message styled as specified */}

//                     <p className="text-lg text-gray-600 mb-8">
//                         Ready to take control of your health and fitness? Join
//                         us today and start tracking your calories, setting
//                         goals, and enjoying healthier meals every day!
//                     </p>
//                     <p className="text-md text-gray-500 mb-6">
//                         Whether you&apos;re looking to lose weight, gain muscle,
//                         or just eat healthier, BrownBite offers personalized
